# Backend-agnostic web console for any S3-compatible object store (`s3-console`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://s3-console.sociobot.in`. Artifact class: `static-web`.
